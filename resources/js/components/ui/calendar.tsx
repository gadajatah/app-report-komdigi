            ...
            <CalendarCell
              ...
              className={composeRenderProps(className, (className, { isSelected, isDisabled }) =>
                twMerge(
                  ...
                  date.compare(now) === 0 &&
                    "after:-translate-x-1/2 after:pointer-events-none after:absolute after:start-1/2 after:bottom-1 after:z-10 after:size-0.75 after:rounded-full after:bg-primary selected:after:bg-primary-fg focus-visible:after:bg-primary-fg",
                  className,
                ),
              )}
            />
